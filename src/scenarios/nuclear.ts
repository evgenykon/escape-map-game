...
export const nuclearScenario: Scenario = {
  ...
  thoughts: [
    { timeSec: 5, text: 'Надо зайти в магазин... Вроде, молоко дома закончилось.' },
    { timeSec: 40, text: 'Черт, опять налёт... Наверное, успею в магазин.' },
    { timeSec: 100, text: 'СТОП, ЧТО??? Ядерный заряд?!' },
    { timeSec: 105, text: 'Надо сваливать!' },
    { timeSec: 120, text: 'Брат, я надеюсь мы еще увидимся с тобой...' },
    { timeSec: 160, text: 'Ага, сохраняю. Еще будут советы?' },
    // { timeSec: 220, text: 'Какой-то кошмар…' },
    // { timeSec: 280, text: 'Главное — не паниковать.' },
    // { timeSec: 330, text: 'Успеть бы до взрыва.' },
    // { timeSec: 400, text: 'Всё будет хорошо… правда?' },
  ],
  ...
  smsTexts: [
    ...
    { timeSec: 150, text: 'Сообщение: Внимание! Не пользуйтесь лифтами. Отключите газ и электричество. Сохраняйте спокойствие.' },
    ...
    { timeSec: 380, text: 'Сообщение: Если вы не успеваете достигнуть убежища, укройтесь в здании.' },
    { timeSec: 400, text: 'Внимание! Опасайтесь оставаться на улицах! Немедленно найдите укрытие!' },
  ],
