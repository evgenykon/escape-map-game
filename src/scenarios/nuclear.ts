...
export const nuclearScenario: Scenario = {
  ...
  timeline: [
    ...
    { timeSec: 105, type: 'thought', texts: ['Надо сваливать!', 'Бежать!', 'Нужно убираться!'] },
    { timeSec: 110, type: 'sms', text: '(Сообщение от друга): Привет! Видел объявление? Мы собираемся сваливать подальше на восток.' },
    ...
    { timeSec: 150, type: 'sms', text: '(Оповещение): Внимание! Ракетная опасность! Спуститесь в подвал. Не пользуйтесь лифтами. Держитесь подальше от окон. Сохраняйте спокойствие.' },
