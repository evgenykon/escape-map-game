...
export const nuclearScenario: Scenario = {
  ...
  smsTexts: [
    ...
    { timeSec: 180, text: 'Сообщение: Экстренные службы открыли убежища. Следуйте указателям на карте.', triggerShelterHud: true },
    ...
    { timeSec: 260, text: 'Внимание! Опасайтесь оставаться на улицах! Немедленно найдите укрытие!' },
  ],
